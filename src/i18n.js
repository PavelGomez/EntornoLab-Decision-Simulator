...
export const T = {
  ...
  s5_costBearer: '¿Quién soporta el costo?',
  s5_costBearerHint: 'La persona, área o grupo que carga el sacrificio. Nómbralo; no lo externalices en silencio a empleados o comunidad.',
  s5_costTiming: '¿Cuándo aparece el costo?',
  s5_costTimingHint: 'Cuándo se materializa: hoy, al activar, semanas después…',
  s5_reversibility: '¿Hasta cuándo es reversible?',
  s5_reversibilityHint: 'El punto a partir del cual ya no puedes deshacer la decisión.',
  s5_floor: 'Piso no negociable',
  s5_floorHint: 'Un deber legal o de cuidado que NO se ofrece como moneda de cambio. Si no aplica, escribe «no aplica» y por qué.',
  s5_floorCasoC: 'En este caso hay pisos no negociables: atención inmediata a la persona afectada, no represalia contra quien reportó y cumplimiento de la normativa vigente. No pueden presentarse como sacrificios estratégicos.',
  s5_floorEthicalHint: 'Cuidado: un deber legal o de atención inmediata no es un sacrificio negociable. Recolócalo como piso, no como moneda de cambio.',
  ...
  microcopy: {
    ...
    tradeoff: 'Una decisión no está completa hasta decir quién paga, cuándo y qué riesgo sigue vivo. Un deber legal o de cuidado no se ofrece como moneda de cambio.',
